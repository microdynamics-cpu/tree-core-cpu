...
// ------------------Process Data------------------
  ...
  protected val axiRdDataLow = WireDefault((io.axiRdDataIn & maskLow) >> alignedOffsetLow)
  protected val axiRdDataHig = WireDefault((io.axiRdDataIn & maskHig) << alignedOffsetHig)
